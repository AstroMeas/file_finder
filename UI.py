...
class UserInterface:
    ...
    def fileformats(self):
        ...
        self.count_timer = 0
        self.formats = []
        for format in self.config_lst['FORMATS']:
            self.formats.append(format)
            self.create_change_button(self.count_timer, format, self.config_lst['FORMATS'][format])
    ...
    def directory_setting(self):
        ...
        self.directory_window.title('Orgner hizufügen')
